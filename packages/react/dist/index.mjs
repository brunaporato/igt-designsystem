...
function Toast({ title, text }) {
  return /* @__PURE__ */ jsxs4(ToastContainer, { children: [
    /* @__PURE__ */ jsxs4("div", { className: "top", children: [
      /* @__PURE__ */ jsx5(Heading, { size: "sm", children: title }),
      /* @__PURE__ */ jsx5(CloseButton, { children: /* @__PURE__ */ jsx5(X, { weight: "bold", size: 20 }) })
    ] }),
